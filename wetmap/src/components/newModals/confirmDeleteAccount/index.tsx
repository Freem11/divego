...
export default function ConfirmDeleteAccount(props: ConfirmDeleteAccountProps) {
  ...
  const handleAccountDelete = async () => {
    if (!profile) {
      toast.error(t('ConfirmDeleteAccount.errorDeleting'));
      return;
    }
